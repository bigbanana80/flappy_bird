...
def draw_floor():
    screen.blit(floor_surface,(floor_x_pos,490))
    screen.blit(floor_surface,(floor_x_pos+576,490))


#generating pipe function and moving them
...
high_score =0
#loading images
bg_surface = pygame.image.load('Assets/bg_flopybird.png').convert()
floor_surface = pygame.image.load('Assets/base.png').convert()
#loading bird
bird_top = pygame.image.load('Assets/bird.png').convert_alpha()
bird_mid = pygame.image.load('Assets/bird_mid.png').convert_alpha()
bird_down = pygame.image.load('Assets/bird_down.png').convert_alpha()
bird_frames = [bird_down,bird_mid,bird_top]
bird_index = 0
...
pipe_height = [200,300,400,350]

game_over_surface = pygame.image.load('Assets/Game_over.png').convert_alpha()
game_over_rect = game_over_surface.get_rect(center = (288,250))
